...
' 14. Send meeting follow-up
Sub SendMeetingFollowUp()
    Dim olApp As Outlook.Application
    Dim olItem As Outlook.MailItem
    ...
    If Not TypeName(olApp.ActiveWindow) = "Inspector" Then
        MsgBox "Please open a meeting first", vbExclamation
        Exit Sub
    End If
    
    If Not TypeName(olApp.ActiveInspector.CurrentItem) = "AppointmentItem" Then
        MsgBox "This is not a meeting", vbExclamation
        Exit Sub
    End If
    
    Set olMeeting = olApp.ActiveInspector.CurrentItem
    Set olItem = olApp.CreateItem(ol
